...
export function PhoneMock() {
  ...
  return (
    ...
    >
      ...
      >
      <Tilt max={8} className="motion-safe:animate-hover">
      <div
        className="relative h-[53em] w-[26em] rounded-[3.4em] bg-[#0d1512] p-[0.32em]"
        style={{
          boxShadow:
      ...
      {/* The floor it stands on: a soft reflection anchors it in the section. */}
      <div
        className="mx-auto mt-[2em] h-[2.5em] w-[20em] rounded-[50%] bg-brand-900/30 blur-xl"
      />
      </div>
    </div>
  );
